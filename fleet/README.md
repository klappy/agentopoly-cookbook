...
## Summary — Pack of 6 live; 7–12 minting (captain override); Otto runner; bias Otto+Auggie this wave

Otto minted the pack of 6 on 2026-09-07. Pack of 3 superseded. **Mint 7–12 in flight** (captain override, Otto); target 20/engine still later Serve. **This wave:** bias Otto (Denmark) + Auggie (Bolivia). Live cash → each seat's `status`. Not copied here.
...
**Pack of 6 live.** Runner Otto pack of 6 every 30m, 8a–8p ET. **7–12 minting — rows land when Otto reports.** Do not invent homes or profiles. Procedure: [`recipes/07-minions.md`](../recipes/07-minions.md). **Loop:** Otto Denmark L3 · Auggie Bolivia L3 · CoS NZ L3. **This wave bias:** Otto + Auggie. **Not** Japan / flagship. Chile skipped. Retract "pack of 6 live" if a later `status`/profile shows holdings or a missing seat among 1–6.
...
- 🍌 **Minions (traffic)** — pack of 6 live (Otto minted 2026-09-07); **7–12 minting** (captain override); zero holdings; target 20/engine still later Serve. Bias Otto+Auggie this wave. Not namesakes, not a fifth guest. See [Minions (traffic)](#minions-traffic). Procedure: [`recipes/07-minions.md`](../recipes/07-minions.md).
