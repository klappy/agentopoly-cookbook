...
| 🍌 disposable traffic Minions (zero-hold drones) | [`recipes/07-minions.md`](recipes/07-minions.md) — pack of 3 live (Otto); loop team engines only (not flagship/Japan); roster in [`fleet/README.md`](fleet/README.md); scale only on later Serve |
