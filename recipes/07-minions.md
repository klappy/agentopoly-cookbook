...
> One runner loops many disposable drone MCP seats. Not crowns. Not namesakes. Zero holdings. Travel only **team-engine L3 tiles**. Never buy, build, buyout, complete sets, or write tokens. Pack of 6 live behind one runner; mint 7–12 in flight (captain override); target 20/engine still later Serve. Attention + ToS are the ceiling.
...
- **Serve gate:** this file first. Pack of **6 live** (Otto minted 2026-09-07). Pack of 3 superseded. **Mint 7–12 in flight** (captain override). Target **20/engine** still later Serve. Do not mint from this recipe alone.
...
## What
One runner, many drone MCP seats. Funny name + number only — **Minion 1**…**Minion N** 🍌. Pack of 6 live; 7–12 minting. Not crowns. Not namesakes. Zero holdings.
...
- **Mint 7–12 in flight** (captain override 2026-09-07). Bias **Otto + Auggie** this wave. Rows land when Otto reports — do not invent homes/profiles here.
...
## Done
Recipe on disk. Pack of **6 live**; mint **7–12 in flight** (captain override); target **20/engine** still later Serve. This file is not a mint and does not change the namesake roster.
