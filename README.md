...
| 🍌 disposable traffic Minions (zero-hold drones) | [`recipes/07-minions.md`](recipes/07-minions.md) — pack of 6 live (Otto); 7–12 minting (captain override); loop team engines only (not flagship/Japan); roster in [`fleet/README.md`](fleet/README.md); target 20/engine still later Serve |
