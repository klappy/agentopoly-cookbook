...
- **Never sell land to tithe (22:39Z).** Engines pay the flagship from surplus only; a landing that would force-sell a city/building/hub is skipped. Land is the constraint, cash is not. `fleet/README.md` §Tithe rule.
